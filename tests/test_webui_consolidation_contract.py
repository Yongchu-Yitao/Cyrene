...
OPENAPI_OPERATION_COUNT = 377
OPENAPI_BASELINE_FASTAPI = "0.136.1"
OPENAPI_BASELINE_PYDANTIC = "2.13.4"
OPENAPI_SHA256 = "5714209c2826ab964b271f597833e01851a5de8d37f22f9f90cc10d6d9772040"
...
def test_workbench_runtime_dependencies_keep_their_relative_script_order():
    ...
    required_in_order = [
        ...
        "purify.min.js",
        "highlight.min.js",
        "compiled/platform/runtime.js?v=0.7.10-beta1",
        "compiled/shared/markdown/math.js?v=0.7.10-beta1",
        "compiled/shared/markdown/highlight.js?v=0.7.10-beta1",
        "leaflet.js",
        "pdfjs/pdf.min.js?v=0.7.10-beta1",
        "pdfjs/pdf_viewer.js?v=0.7.10-beta1",
        "compiled/platform/readiness.js?v=0.7.10-beta1",
        "compiled/platform/events.js?v=0.7.10-beta1",
        "compiled/platform/navigation.js?v=0.7.10-beta1",
        "compiled/workbench-i18n.js?v=0.7.10-beta1",
        "compiled/shared/i18n/format.js?v=0.7.10-beta1",
        "compiled/shared/i18n/translations.js?v=0.7.10-beta1",
        "compiled/shared/pdf/bridge.js?v=0.7.10-beta1",
        "compiled/shared/feedback/service.js?v=0.7.10-beta1",
        "compiled/shared/markdown/renderer.js?v=0.7.10-beta1",
        "compiled/platform/data-store.js?v=0.7.10-beta1",
        "compiled/shared/browser/viewport.js?v=0.7.10-beta1",
        "compiled/shared/search/overlay.js?v=0.7.10-beta1",
        "compiled/shared/markdown/actions.js?v=0.7.10-beta1",
        "compiled/shared/diff/viewer.js?v=0.7.10-beta1",
        "compiled/code/editor.js?v=0.7.10-beta1",
        "compiled/platform/api.js?v=0.7.10-beta1",
        "compiled/workbench-chat.js?v=0.7.10-beta1",
        "compiled/workbench-quick-chat.js?v=0.7.10-beta1",
        "compiled/workbench.js?v=0.7.10-beta1",
        "compiled/settings-overlay.js?v=0.7.10-beta1",
        "compiled/entry/bootstrap.js?v=0.7.10-beta1",
    ]

    positions = [scripts.index(script) for script in required_in_order]
    assert positions == sorted(positions)
    assert not {
        "compiled/app.js?v=0.7.10-beta1",
        "compiled/chat.js?v=0.7.10-beta1",
        "compiled/dashboard.js?v=0.7.10-beta1",
        "compiled/knowledge.js?v=0.7.10-beta1",
        "compiled/memory.js?v=0.7.10-beta1",
        "compiled/tasks.js?v=0.7.10-beta1",
        "compiled/settings.js?v=0.7.10-beta1",
