...
def test_workbench_uses_one_module_entry_after_ordered_vendor_scripts():
    ...
    required_in_order = [
        ...
        "echarts.min.js",
        "leaflet.js",
        "pdfjs/pdf.min.js?v=0.9.0-beta13",
        "pdfjs/pdf_viewer.js?v=0.9.0-beta13",
        "compiled/app.js?v=0.9.0-beta13",
    ]
    ...
    assert compiled_scripts == ["compiled/app.js?v=0.9.0-beta13"]
    assert '<script type="module" src="compiled/app.js?v=0.9.0-beta13"></script>' in index
