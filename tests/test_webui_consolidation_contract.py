...
def test_workbench_runtime_dependencies_keep_their_relative_script_order():
    ...
    required_in_order = [
        ...
        "purify.min.js",
        "highlight.min.js",
        "compiled/platform/runtime.js?v=0.7.0b7",
        ...
        "compiled/shared/browser/viewport.js?v=0.7.0b7",
        "compiled/shared/search/overlay.js?v=0.7.0b7",
        "compiled/shared/markdown/actions.js?v=0.7.0b7",
        "compiled/shared/diff/viewer.js?v=0.7.0b7",
        "compiled/platform/api.js?v=0.7.0b7",
        "compiled/workbench-chat.js?v=0.7.0b7",
        "compiled/workbench-quick-chat.js?v=0.7.0b7",
        "compiled/workbench.js?v=0.7.0b7",
        "compiled/settings-overlay.js?v=0.7.0b7",
        "compiled/entry/bootstrap.js?v=0.7.0b7",
    ]

    positions = [scripts.index(script) for script in required_in_order]
    assert positions == sorted(positions)
    assert not {
        "compiled/app.js?v=0.7.0b7",
        "compiled/chat.js?v=0.7.0b7",
        "compiled/dashboard.js?v=0.7.0b7",
        "compiled/knowledge.js?v=0.7.0b7",
        "compiled/memory.js?v=0.7.0b7",
        "compiled/tasks.js?v=0.7.0b7",
        "compiled/settings.js?v=0.7.0b7",
