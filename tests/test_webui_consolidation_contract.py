...
OPENAPI_OPERATION_COUNT = 298
OPENAPI_BASELINE_FASTAPI = "0.136.1"
OPENAPI_BASELINE_PYDANTIC = "2.13.4"
OPENAPI_SHA256 = "3e398e0bea5f9ca875b8303a5e7f52b71dbad70f609bbb0ca79dd0834d6f8674"
TOOL_REGISTRY_SHA256 = "c88cf4eb36ade0c6ba75b9b733173bec38c003a9423280c6bcf2af8f37b0b4e7"
...
def test_workbench_runtime_dependencies_keep_their_relative_script_order():
    ...
    required_in_order = [
        ...
        "purify.min.js",
        "highlight.min.js",
        "compiled/platform/runtime.js?v=0.7.0b6",
        "compiled/shared/markdown/math.js?v=0.7.0b6",
        "compiled/shared/markdown/highlight.js?v=0.7.0b6",
        "leaflet.js",
        "pdfjs/pdf.min.js?v=0.7.4",
        "pdfjs/pdf_viewer.js?v=0.7.4",
        "compiled/platform/readiness.js?v=0.7.0b6",
        "compiled/platform/events.js?v=0.7.0b6",
        "compiled/platform/navigation.js?v=0.7.0b6",
        "compiled/workbench-i18n.js?v=0.7.0b6",
        "compiled/shared/i18n/format.js?v=0.7.0b6",
        "compiled/shared/i18n/translations.js?v=0.7.0b6",
        "compiled/shared/pdf/bridge.js?v=0.7.4",
        "compiled/shared/feedback/service.js?v=0.7.0b6",
        "compiled/shared/markdown/renderer.js?v=0.7.0b6",
        "compiled/platform/data-store.js?v=0.7.0b6",
        "compiled/shared/browser/viewport.js?v=0.7.0b6",
        "compiled/shared/search/overlay.js?v=0.7.0b6",
        "compiled/shared/markdown/actions.js?v=0.7.0b6",
        "compiled/shared/diff/viewer.js?v=0.7.0b6",
        "compiled/platform/api.js?v=0.7.0b6",
        "compiled/workbench-chat.js?v=0.7.0b6",
        "compiled/workbench-quick-chat.js?v=0.7.0b6",
        "compiled/workbench.js?v=0.7.0b6",
        "compiled/settings-overlay.js?v=0.7.0b6",
        "compiled/entry/bootstrap.js?v=0.7.0b6",
    ]

    positions = [scripts.index(script) for script in required_in_order]
    assert positions == sorted(positions)
    assert not {
        "compiled/app.js?v=0.7.0b6",
        "compiled/chat.js?v=0.7.0b6",
        "compiled/dashboard.js?v=0.7.0b6",
        "compiled/knowledge.js?v=0.7.0b6",
        "compiled/memory.js?v=0.7.0b6",
        "compiled/tasks.js?v=0.7.0b6",
        "compiled/settings.js?v=0.7.0b6",
