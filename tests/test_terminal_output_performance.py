...
async def test_persistence_backpressure_pauses_and_resumes_posix_reader(
    ...
    monkeypatch.setattr("cyrene.plugins.builtin.cyrene_code.terminal.manager.os.read", lambda _fd, _size: payload)
...
def test_posix_reader_processes_at_most_one_budget_per_callback(
    ...
    monkeypatch.setattr("cyrene.plugins.builtin.cyrene_code.terminal.manager.os.read", fake_read)
