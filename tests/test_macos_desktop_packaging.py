...
def test_extension_runtime_installers_are_built_and_packaged():
    ...
    before_pack = (ROOT / "electron" / "scripts/build-app-use-macos.js").read_text(encoding="utf-8")
    runtime_builder = (ROOT / "electron" / "scripts/build-runtime-tools.js").read_text(encoding="utf-8")
