...
from .context import NodeNotFoundError

if TYPE_CHECKING:
    from .session import AgentSession, AgentSessionEvent


_ROOT_METADATA_KEY = "_cyrene_subagents"
...
class SubagentManager:
    ...
    def _load_records(self) -> dict[str, SubagentRecord]:
        ...
        raw_records = value.get(_ROOT_METADATA_KEY)
    ...
    def _persist(self) -> None:
        with self._lock:
            ...
            value = deepcopy(dict(root.value))
            value[_ROOT_METADATA_KEY] = {
    ...
    def _open_session(self, record: SubagentRecord) -> AgentSession:
        ...
        child = AgentSession(
            ...
            initial_root_value=self.owner.initial_root_value,
