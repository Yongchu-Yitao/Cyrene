...
async def _proactive_tick(bot: Any, db_path: str) -> None:
    from agent.plugin.background import maintenance_lock
...
class ProactiveService:
    ...
    async def tick(self) -> None:
        ...
        await _proactive_tick(self.bot, self.db_path)
    ...
    async def settings_changed(
        ...
        from agent.plugin.background import reconcile_background_plugin_hosts
