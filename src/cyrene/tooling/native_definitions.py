...
_NATIVE_TOOL_DEFS: tuple[dict[str, Any], ...] = tuple([{'type': 'function',
 ...
 {'type': 'function',
  'function': {'name': 'ManageExtensions',
               'description': 'List, search, install, uninstall, enable, disable, or select a default version for Cyrene Skills, MCP servers, CLI tools, and toolchains. Persistent mutations always pass through the reviewer even in full_access mode.',
               'parameters': {'type': 'object',
                              'properties': {'action': {'type': 'string', 'enum': ['list', 'search', 'install', 'uninstall', 'enable', 'disable', 'set_default']},
                                             'kind': {'type': 'string', 'enum': ['skill', 'mcp', 'cli', 'toolchain']},
                                             'extension_id': {'type': 'string'},
                                             'query': {'type': 'string'},
                                             'version': {'type': 'string'},
                                             'advanced': {'type': 'boolean'},
                                             'request': {'type': 'object', 'description': 'Type-specific fixed source/version/configuration returned by extension search.'}},
                              'required': ['action']}}},
 {'type': 'function',
