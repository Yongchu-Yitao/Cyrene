...
_NATIVE_TOOL_DEFS: tuple[dict[str, Any], ...] = tuple([{'type': 'function',
 ...
 {'type': 'function',
  'function': {'name': 'WebSearch',
               'description': 'Search the web, fetch relevant pages, filter them for relevance, and return source URLs with detailed fetched excerpts. Synthesize the answer from this evidence; do not call WebFetch for its listed URLs unless the user explicitly requests an exact quotation/full-page verification or a required detail is absent.',
