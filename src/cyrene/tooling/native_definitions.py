...
_NATIVE_TOOL_DEFS: tuple[dict[str, Any], ...] = tuple([{'type': 'function',
 ...
 {'type': 'function',
  'function': {'name': 'WebSearch',
               'description': 'Search the web, fetch relevant pages, and return a self-contained synthesized answer with source URLs and detailed fetched excerpts. Use the returned evidence directly; do not call WebFetch for its listed URLs unless the user explicitly requests an exact quotation/full-page verification or a required detail is absent.',
