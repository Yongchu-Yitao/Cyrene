...
def _soul_application() -> Any | None:
    ...
    return application_plugin_service("soul")
...
class MemoryApplication:
    ...
    def create(
        ...
        *,
        ...
        from cyrene.workbench.sessions.context import configure_store, read_projects
    ...
    def _search(self, query: str, limit: int) -> list[dict[str, Any]]:
        ...
        from cyrene.workbench.persistence.store import list_document_keys, read_document
    ...
    def has_existing_data(self) -> bool:
        ...
        if not self.db_path or not Path(self.db_path).exists():
            return False
        from cyrene.workbench.persistence.store import list_document_keys
    ...
    async def reset_data(self) -> None:
        ...
        from cyrene.workbench.persistence.store import delete_document, list_document_keys
