...
APP_OPERATIONS: tuple[AppOperationSpec, ...] = (
    ...
    _op("cyrene.browser", "browser", "existing_capability", "browser_tools", "R1", actors=("main",)),
    _op("cyrene.tasks", "task", "existing_capability", "task_tools", "R1"),
    _op("cyrene.memory", "memory", "existing_capability", "memory_tools", "R1"),
    _op("cyrene.knowledge", "knowledge", "existing_capability", "knowledge_tools", "R1"),
    _op("cyrene.skills", "skills", "existing_capability", "skill_tools", "R2"),
    _op("cyrene.remote", "remote", "existing_capability", "remote_tools", "R2"),
    _op("cyrene.delivery", "delivery", "existing_capability", "delivery_tools", "R2"),
    _op("cyrene.code", "code", "existing_capability", "code_tools", "R1"),
