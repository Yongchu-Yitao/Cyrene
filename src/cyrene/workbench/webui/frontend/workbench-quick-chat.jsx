...
// message cards registered by the chat service rather than
...
function QuickChatApp() {
  ...
  function resetSession() {
    ...
    if (composerChatId && typeof chatService.clearComposerDraft === "function") {
      chatService.clearComposerDraft(composerChatId, "quick-chat:");
    }
            ...
            <div className="wbq-footer">
              ...
              {composerReady ? (
                <div className="wbq-composer-host">
                  {React.createElement(chatService.Composer, {
                    key: composerKey,
                    chat: composerChat,
...
window.CyreneUI.quickChat = window.CyreneUI.register("quickChat", {
  App: QuickChatApp,
});
