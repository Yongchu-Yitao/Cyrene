...
from cyrene.plugins.model_router import MODEL_ROUTER_PLUGIN
...
async def run_workbench_chat(
    *,
    ...
    def open_bridge() -> WorkbenchSessionBridge:
        registry, load_plugins = resolve_plugin_registry(plugin_root)
        ...
        return WorkbenchSessionBridge.open(
            ...
            plugin_context_data={
                ...
                "memory_short_term_enabled": bool(memory_short_term_enabled),
                "memory_project_enabled": bool(memory_project_enabled),
                "retry": bool(retry),
