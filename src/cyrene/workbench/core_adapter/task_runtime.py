...
from cyrene.core.context.projection import project_context_message
from cyrene.core.plugin import (
    PluginContext,
    default_plugin_impl_directory,
    plugin_child_context_ids,
)
from cyrene.plugins.model_router import (
    MODEL_ROUTER_PLUGIN,
)
...
class TaskAgentRuntime:
    ...
    def _open_bridge(
        ...
        *,
        ...
        from cyrene.plugins import application_plugin_scope, resolve_plugin_registry

        registry, load_plugins = resolve_plugin_registry(
        ...
        return WorkbenchSessionBridge.open(
            ...
            application_scope=application_plugin_scope(),
        ...
        try:
            ...
            result = await bridge.session.runtime.call(
                ...
                PluginContext(
                    ...
                    data=data,
                    services=bridge.session.application_plugin_services(),
                ),
                call_id=run_id,
            )
    ...
    async def generate_init_form(
        ...
        *,
        ...
        from cyrene.workbench.tasks import task_initialization_runtime
