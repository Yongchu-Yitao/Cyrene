...
from cyrene.media.models import MEDIA_KINDS, TERMINAL_JOB_STATUSES
...
class MediaJobManager:
    ...
    def __init__(self, db_path: str | Path | None = None) -> None:
        self.db_path = Path(db_path or (DATA_DIR / "media_jobs.sqlite3"))
...
__all__ = ["MediaJobManager", "get_media_job_manager"]
