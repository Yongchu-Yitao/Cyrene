...
from cyrene.agents.acp_events import (
    AcpEventMapper,
...
from cyrene.agents.acp_transport import (
    AcpStdioTransport,
    AcpTransportError,
)
...
from cyrene.agents.capabilities import normalize_capabilities
from cyrene.agents.driver import AgentStartRequest
from cyrene.agents.errors import AgentRuntimeError
from cyrene.agents.events import event_envelope
from cyrene.agents.models import AgentDescriptor, ModelAccess
from cyrene.agents.process_manager import (
    ACP_STDIO_DRIVER,
    AcpProcessManager,
    get_process_manager,
)
...
def default_model_binder() -> EnvModelBinder:
    ...
    if _DEFAULT_BINDER is None:
        from cyrene.agents.model_gateway import issue_model_gateway_binding
    ...
    *,
    ...
    try:
        ...
        if session_id_hint and model_access.mode == "cyrene_managed":
            from cyrene.agents.model_gateway import is_model_gateway_session_current
        ...
        if model_access.mode == "cyrene_managed" and connection.session_id:
            from cyrene.agents.model_gateway import mark_model_gateway_session_current
...
async def respond_to_external_agent_request(
    ...
    from cyrene.agents.model_gateway import touch_model_gateway_scope
