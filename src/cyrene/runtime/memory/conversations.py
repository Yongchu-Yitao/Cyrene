...
# Historical internal name retained for existing callers and tests.
_upsert_session_title = upsert_archive_session_title
...
# Historical internal names retained for existing callers.
_parse_archive_meta = parse_archive_meta
_split_archive_entry_blocks = split_archive_entry_blocks
