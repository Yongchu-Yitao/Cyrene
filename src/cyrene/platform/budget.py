...
from cyrene.model.pricing import CNY_PER_USD
from cyrene.localization import localized
from cyrene.platform.settings_store import get_all as _get_all_settings
...
def _save_state(state: BudgetState) -> None:
    from cyrene.platform.settings_store import set_ as _set
