...
from cyrene.platform.persistence.telemetry import TelemetryRepository, TokenUsageEvent
...
def _estimate_cost(
    ...
    *,
    ...
    from cyrene.model.pricing import cost_to_cny, effective_price, estimate_cost
