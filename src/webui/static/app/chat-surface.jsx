...
var CYRENE_TOOL_NAME_I18N = {
  zh: {
    ...
    Grep: "搜索文本",
    IndexCodebase: "索引代码库",
    GetLearnedSkill: "查看自动技能",
    InstallSkill: "安装技能",
    LintCode: "检查代码",
    ListShells: "列出 Shell",
    ListSkills: "列出技能",
    RunLearnedSkill: "运行自动技能",
    PromptClaudeCode: "提示 Claude Code",
    Read: "读取文件",
    RecallMemory: "回忆记忆",
    RecallConversation: "回忆历史对话",
    retire_short_term_memory: "停用短期记忆",
    ...
    browser_click: "点击网页",
    browser_click_at: "点击网页坐标",
    browser_click_ref: "点击网页引用",
    browser_click_text: "点击网页文本",
    browser_navigate: "打开网页",
    browser_network_log: "查看网页网络",
    browser_request_takeover: "请求浏览器接管",
    browser_screenshot: "截取网页",
    browser_scroll: "滚动网页",
    browser_snapshot: "检查网页",
    browser_tab_close: "关闭网页标签",
    browser_tab_list: "列出网页标签",
    browser_tab_new: "新建网页标签",
    browser_tab_select: "选择网页标签",
    browser_type: "输入网页内容",
    browser_type_ref: "输入网页引用",
    browser_upload_files: "上传网页文件",
    browser_wait: "等待网页",
    cancel_task: "取消计划",
    connect_pins: "连接地图标记",
    delete_entity: "删除实体",
  ...
  en: {
    ...
    entity_tools: "Entity tools",
    integration_tools: "Integration tools",
    knowledge_tools: "Knowledge tools",
    map_tools: "Map tools",
    ...
    GetLearnedSkill: "View learned skill",
    Glob: "Find files",
    Grep: "Search text",
    ...
    retire_project_memory: "Retire project memory",
    retire_short_term_memory: "Retire short-term memory",
    RunLearnedSkill: "Run learned skill",
    ...
    browser_click_ref: "Click browser ref",
    browser_click_text: "Click browser text",
    browser_navigate: "Navigate browser",
    browser_network_log: "Inspect network",
    browser_request_takeover: "Request browser takeover",
    browser_screenshot: "Take screenshot",
    browser_scroll: "Scroll page",
    browser_snapshot: "Inspect browser",
    browser_tab_close: "Close browser tab",
    browser_tab_list: "List browser tabs",
    browser_tab_new: "New browser tab",
    browser_tab_select: "Select browser tab",
    browser_type: "Type in browser",
    browser_type_ref: "Type browser ref",
    browser_upload_files: "Upload browser files",
    browser_wait: "Wait browser",
