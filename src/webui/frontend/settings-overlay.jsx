...
function AgentsPanel(p) {
  ...
  return React.createElement("div", { className: "settings-panel" },
    ...
    FieldRow(t("settings.executionSafetyToolCalls"), t("settings.executionSafetyToolCallsHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "1", max: "5000", step: "1", value: config.subagent_execution_max_tool_calls || 200, onChange: function (e) { setConfig({ ...config, subagent_execution_max_tool_calls: Number(e.target.value) || 200 }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.executionSafetyWallTime"), t("settings.executionSafetyWallTimeHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "30", max: "86400", step: "30", value: config.subagent_execution_max_wall_seconds || 1800, onChange: function (e) { setConfig({ ...config, subagent_execution_max_wall_seconds: Number(e.target.value) || 1800 }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.executionNoProgress"), t("settings.executionNoProgressHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "1", max: "20", step: "1", value: config.subagent_execution_no_progress_turns || 3, onChange: function (e) { setConfig({ ...config, subagent_execution_no_progress_turns: Number(e.target.value) || 3 }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.executionCheckpoint"), t("settings.executionCheckpointHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "1", max: "500", step: "1", value: config.subagent_execution_checkpoint_calls || 20, onChange: function (e) { setConfig({ ...config, subagent_execution_checkpoint_calls: Number(e.target.value) || 20 }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.executionCost"), t("settings.executionCostHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "0", max: "1000", step: "0.1", value: config.subagent_execution_max_cost_usd == null ? 5 : config.subagent_execution_max_cost_usd, onChange: function (e) { setConfig({ ...config, subagent_execution_max_cost_usd: Number(e.target.value) }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.executionContext"), t("settings.executionContextHint"),
      React.createElement("input", { className: "wb-input mono", type: "number", min: "0", max: "4000000", step: "1000", value: config.subagent_execution_max_context_tokens == null ? 0 : config.subagent_execution_max_context_tokens, onChange: function (e) { setConfig({ ...config, subagent_execution_max_context_tokens: Number(e.target.value) }); }, style: { maxWidth: 120 } }),
    ),
    FieldRow(t("settings.discussionLimits"), t("settings.discussionLimitsHint"),
      React.createElement("div", { className: "wb-inline-row", style: { gap: 8, flexWrap: "wrap" } },
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionRounds"), type: "number", min: "1", max: "50", value: config.subagent_discussion_max_rounds || 5, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_rounds: Number(e.target.value) || 5 }); }, style: { maxWidth: 92 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionMessagesPerAgent"), type: "number", min: "1", max: "50", value: config.subagent_discussion_max_messages_per_agent || 4, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_messages_per_agent: Number(e.target.value) || 4 }); }, style: { maxWidth: 92 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionTotalMessages"), type: "number", min: "1", max: "500", value: config.subagent_discussion_max_total_messages || 20, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_total_messages: Number(e.target.value) || 20 }); }, style: { maxWidth: 92 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionMessageChars"), type: "number", min: "100", max: "20000", step: "100", value: config.subagent_discussion_max_message_chars || 2000, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_message_chars: Number(e.target.value) || 2000 }); }, style: { maxWidth: 102 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionWallTime"), type: "number", min: "30", max: "86400", step: "30", value: config.subagent_discussion_max_wall_seconds || 600, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_wall_seconds: Number(e.target.value) || 600 }); }, style: { maxWidth: 102 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionToolCalls"), type: "number", min: "1", max: "1000", value: config.subagent_discussion_max_tool_calls || 50, onChange: function (e) { setConfig({ ...config, subagent_discussion_max_tool_calls: Number(e.target.value) || 50 }); }, style: { maxWidth: 92 } }),
        React.createElement("input", { className: "wb-input mono", "aria-label": t("settings.discussionNoNewInfo"), type: "number", min: "1", max: "20", value: config.subagent_discussion_no_new_info_rounds || 2, onChange: function (e) { setConfig({ ...config, subagent_discussion_no_new_info_rounds: Number(e.target.value) || 2 }); }, style: { maxWidth: 92 } }),
      ),
    ),
    React.createElement("div", { className: "wb-save-actions" },
