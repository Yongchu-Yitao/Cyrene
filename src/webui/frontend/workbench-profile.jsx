...
// workbench.css). It shares only the Workbench platform data service
...
(function () {
  ...
  var WBP_FEATURE_LABELS = {
    ...
    WebSearch: { en: "Web search", zh: "联网搜索" },
    web_fetch: { en: "Fetch page", zh: "网页抓取" },
    WebFetch: { en: "Fetch page", zh: "网页抓取" },
    fetch_url: { en: "Fetch page", zh: "网页抓取" },
    browser: { en: "Browser", zh: "浏览器" },
    run_shell: { en: "Shell", zh: "终端" },
    bash: { en: "Shell", zh: "终端" },
    Bash: { en: "Shell", zh: "终端" },
    StartShell: { en: "Shell", zh: "终端" },
    SendShell: { en: "Shell", zh: "终端" },
    Read: { en: "Read file", zh: "读文件" },
    read_file: { en: "Read file", zh: "读文件" },
    Write: { en: "Write file", zh: "写文件" },
    write_file: { en: "Write file", zh: "写文件" },
    Edit: { en: "Edit file", zh: "改文件" },
    edit_file: { en: "Edit file", zh: "改文件" },
    save_project_memory: { en: "Memory", zh: "记忆" },
    RecallMemory: { en: "Recall", zh: "回忆" },
          ...
          <div className={"wbp-hero" + (editing ? " is-editing" : "")}>
            ...
            {!editing ? (
              <>
                ...
                <div className="wbp-handle">@{user.handle} · {dataStore.state.appVersion || "—"}</div>
  ...
  window.CyreneUI.profile = window.CyreneUI.register("profile", {
    Avatar: WorkbenchAvatar,
    Page: WorkbenchProfilePage,
  });
})();
