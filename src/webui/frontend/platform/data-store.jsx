// Cyrene Workbench platform data store.
...
// The explicit platform event bridge owns subscribers and the recent ring.
const UI_EVENTS = window.CyreneUI.require("events");
...
var DATA_STORE = {
  state: DATA,
  bump: bumpData,
  useVersion: useDataVersion,
  reload: bootstrapData,
  refreshSessions: refreshSessions,
  refreshStatus: refreshStatus,
  refreshDashboard: refreshDashboard,
  connectEvents: connectEvents,
  ready: null,
  dispose: disposeDataStore,
};
window.CyreneUI.data = window.CyreneUI.register("data", DATA_STORE);
DATA_STORE.ready = bootstrapData().then(function () {
  connectEvents();
});
