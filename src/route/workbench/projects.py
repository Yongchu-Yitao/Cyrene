...
from route.workbench.project_routes.files import register_project_query_file_routes
from route.workbench.project_routes.lifecycle import register_project_lifecycle_routes
from route.workbench.project_routes.notifications import (
    register_project_notification_routes,
)
from route.workbench.project_routes.tasks import register_project_task_routes
