...
Android 现已与桌面端统一使用 Cyrene 名称和版本。以下保留旧移动端的历史记录。

## [0.9.0] - 2026-09-20

本版与桌面端统一正式发布。跨对话 Agent 协作、对话恢复、长任务可靠性、长对话性能、流式显示、桌面窗口及模型设置的全部变化统一记录在[主更新日志](../CHANGELOG.md#090---2026-09-20)。

## [0.9.0-beta20] - 2026-09-11

本版本与桌面端一起发布。Android 工作空间休眠与恢复、全屏原生浏览器、移动界面及 DeepSeek 对话兼容性变化统一记录在[主更新日志](../CHANGELOG.md#090-beta20---2026-09-11)。

## [0.9.0-beta19] - 2026-09-11

本版本与桌面端一起发布。Android 原生浏览器、分阶段启动进度、运行稳定性、移动界面及所有功能变化统一记录在[主更新日志](../CHANGELOG.md#090-beta19---2026-09-11)。

## [0.9.0-beta18] - 2026-09-10

本版本与桌面端一起发布。Android 单 APK、响应式 Workbench、手势侧栏及所有界面与功能变化统一记录在[主更新日志](../CHANGELOG.md#090-beta18---2026-09-10)。
