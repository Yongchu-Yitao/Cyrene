...
(function() {
  ...
  const TRANSLATIONS = {
    ...
    'nav.architecture': { zh: '插件原生架构', en: 'Plugin-Native Architecture' },
    ...
    'page.architecture': { zh: '插件原生 Agent、Conversation Workspace 与安全模型', en: 'Plugin-native Agent, conversation workspace, and security model' },
