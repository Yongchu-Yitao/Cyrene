...
- Repository: `README.md`, `docs/architecture.md`, `src/cyrene/db.py`, `src/cyrene/report_export.py`, `src/cyrene/knowledge/`, `src/webui/routes_workbench_knowledge.py`, `src/workbench-webui/workbench.jsx`, and `src/workbench-webui/workbench-model.jsx`.
