...
- 代码：`src/cyrene/workbench/webui/frontend/settings-overlay.jsx:3326`、`:3335`、`:3343`、`:3345`、`:7810`。
...
- 代码：`src/cyrene/workbench/webui/frontend/workbench-chat.jsx:15449`。
...
- 代码：`src/cyrene/tooling/runtime_support.py:424`、`src/cyrene/workbench/webui/frontend/workbench-i18n.jsx:7944`。
...
- WCAG：1.4.3。
- 代码：`src/cyrene/workbench/webui/frontend/shared/theme/base.css:15`、`:56`；`src/cyrene/workbench/webui/frontend/workbench.css:24453`、`:24503`。
...
- WCAG：1.3.1、4.1.2。
- 代码：`src/cyrene/workbench/webui/frontend/workbench-chat.jsx:18245`、`:18439`。
...
- 代码：`src/cyrene/workbench/webui/frontend/workbench-chat.jsx:15462`。
