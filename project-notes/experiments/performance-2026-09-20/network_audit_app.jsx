...
export function AuditApp(){
  ...
  React.useEffect(()=>{
    ...
    const report=()=>{
      ...
      parent.postMessage({kind:'audit-result',variant:__AUDIT_VARIANT__,step,html:root.innerHTML,text:root.textContent,geometry,rows:rows.length,preserved,fastHits:window.__auditFastHits,actions,viewport,inputEvents,editValues:Array.from(root.querySelectorAll('.wbc-edit-textarea'),x=>x.value)},location.origin);
    };
