...
Generated: `2026-09-20T12:27:41.659043+00:00`

| Group | Scenario | Parallel | Rounds | Primary metric | Result | Cache progression | Ideal cache | Quality |
|---|---|---:|---:|---|---:|---|---:|---|
| chat | single_heavy_run | 2 | 3 | run_latency_p95_ms | 74.587 ms | 0.00% → 7.77% → 36.14% | 36.14% | pass |
| chat | dense_concurrency | 24 | 3 | run_latency_p95_ms | 446.948 ms | 0.00% → 7.77% → 36.14% | 36.14% | pass |
| chat | multi_tool_storm | 12 | 3 | run_latency_p95_ms | 751.605 ms | 0.00% → 7.77% → 36.14% | 36.14% | pass |
