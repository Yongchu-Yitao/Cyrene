...
for(const variant of ['baseline','candidate']) {
 ...
 let contents=readFileSync(variant==='baseline'?new URL('../full-optimization-2026-09-20/baseline/src/cyrene/workbench/webui/frontend/features/chat/'+name,import.meta.url):args.path,'utf8');
