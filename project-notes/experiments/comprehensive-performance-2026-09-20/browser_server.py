...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if target=='/': data=HTML.encode();kind='text/html'
        ...
        elif target=='/browser-bundle.js':data=(HERE/'browser-bundle.js').read_bytes();kind='text/javascript'
    ...
    def do_POST(self):
        ...
        (HERE/'browser-results.json').write_text(json.dumps(data,indent=2)+'\n')
